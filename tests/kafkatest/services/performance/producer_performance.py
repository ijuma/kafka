...
class ProducerPerformanceService(JmxMixin, PerformanceService):
    ...
    def start_cmd(self, node):
        ...
        cmd += "JMX_PORT=%(jmx_port)d KAFKA_OPTS=%(kafka_opts)s KAFKA_HEAP_OPTS=\"-Xms512m -Xmx512m -XX:+HeapDumpOnOutOfMemoryError\" %(kafka_run_class)s org.apache.kafka.tools.ProducerPerformance " \
