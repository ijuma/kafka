...
# have added remotes corresponding to both (i) the github apache kafka
# mirror and (ii) the apache kafka git repo.
...
def standardize_jira_ref(text):
    ...
    >>> standardize_jira_ref("[WIP] %s-1146; Vagrant support for Spark" % CAPITALIZED_PROJECT_NAME)
    'KAFKA-1146; [WIP] Vagrant support for Spark'
